...
- 🌐 **Mapas de calor** por región y época
- 🔗 **Red de colaboración** entre artistas
- 📊 **Desglose porcentual** de participación en proyectos
- 🎯 **Correlaciones entre géneros** por influencia y época
- 🏆 **Predicción de éxito musical** basada en datos históricos
- ⭐ **Análisis de centralidad** para identificar artistas clave
...
1. **vw_genre_popularity_timeline** - Evolución de géneros en el tiempo
2. **vw_artist_popularity_by_country** - Distribución geográfica de artistas
3. **vw_artist_collaboration_network** - Conexiones entre artistas
4. **vw_album_participation_breakdown** - Análisis de álbumes
5. **vw_genre_correlations_by_era** - Relaciones entre géneros
6. **vw_music_success_prediction** - Métricas de éxito
7. **vw_artist_centrality_analysis** - Influencia de artistas
8. **vw_genre_heatmap_by_region_era** - Mapa de calor geográfico
9. **vw_dashboard_summary** - Resumen estadístico
10. **vw_popularity_trends_by_decade** - Tendencias históricas
